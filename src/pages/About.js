    ...
    <div>
      ...
      <p className={aboutclass.p}>
        <i>
          ...
          specialized e-commerce platform that promotes the opposite. We believe
          that this will help promote creative believers and would help shift
          culture to seek and promote God’s Kingdom on Earth as it is in Heaven.
        </i>
      </p>
      ...
      <p className={aboutclass.p}>
        <i>
          ...
          go ahead and click the SignUp link to get started. If you are looking
          to purchase art and music from us, go ahead and click the Home link,
          where the View Listings button will be to direct you to our gallery of
          works. What are you waiting for, check out our platform!
        </i>
      </p>
    </div>
  );
